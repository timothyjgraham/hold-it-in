...
export const ENEMY_INTRO_DATA = {
    ...
    drunk:       { wave: 8,  name: 'THE DRUNKEN WORKERS', tagline: "Someone raided the supply closet!", traits: ['They march in a conga line', 'Wobble and sway dangerously', 'Strength in numbers'],                                        walkState: 'wobble_walk' },
    ...
    ant:         { wave: 8,  name: 'THE GIANT ANTS',     tagline: "Something is marching this way...", traits: ['March in perfect lockstep', 'Fast but fragile individually', 'The column never stops'],                                   walkState: 'march' },
    ...
    seahorse:    { wave: 8,  name: 'THE SEA HORSES',     tagline: "A chain of shapes drifts along the shore!", traits: ['They drift in single file', 'Always hug the far edge', 'Gentle but persistent'],                                    walkState: 'drift' },
    ...
    trolley:     { wave: 8,  name: 'THE DRINKS TROLLEY',  tagline: "Service coming through!",               traits: ['Unstoppable once rolling', "Can't be knocked back", 'The cart blocks the entire aisle'],                              walkState: 'push_walk' },
};

export const INTRO_WAVE_MAP = {
    office:   { 3: 'dancer', 5: 'waddle', 7: 'panicker', 8: 'drunk', 9: 'powerwalker', 10: 'girls' },
    forest:   { 3: 'squirrel', 5: 'bear', 7: 'fox', 8: 'ant', 9: 'moose', 10: 'raccoon' },
    ocean:    { 3: 'flyfish', 5: 'shark', 7: 'pirate', 8: 'seahorse', 9: 'seaturtle', 10: 'jellyfish' },
    airplane: { 3: 'business', 5: 'stumbler', 7: 'attendant', 8: 'trolley', 9: 'marshal', 10: 'unruly' },
};
